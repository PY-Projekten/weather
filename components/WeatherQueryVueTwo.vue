  ...
  <div>
    ...
    <div>
      ...
      <v-autocomplete
        ...
        ref="autocomplete"
        v-model="location"
        :items="locationsList.map(loc => loc.name)"
        @focus="handleFocus"
...
export default {
  ...
  watch: {
    ...
    location(newVal) {
      // Find the full location object based on the selected name
      this.selectedLocation = this.locationsList.find(loc => loc.name === newVal) || {};
    },
...
<!--      }-->
<!--    },-->
<!--    async onLocationSelect(locationName) {-->
<!--      if (!locationName) return;-->

<!--      // Find the location object from the locationsList-->
<!--      const selectedLocationObj = this.locationsList.find(loc => loc.name === locationName);-->

<!--      if (!selectedLocationObj) {-->
<!--        console.error('Selected location not found in the list');-->
<!--        return;-->
<!--      }-->

<!--      try {-->
<!--        // Fetch location details using the ID from the selected location object-->
<!--        const locationDetails = await this.$repository.weather.getLocation(selectedLocationObj.id);-->
